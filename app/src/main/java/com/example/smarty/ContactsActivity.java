...
public class ContactsActivity extends AppCompatActivity implements MyAdapterContacts.OnItemClickListener {
    ...
    public void onCallClick(Contact contact) {
        ...
        if (ContextCompat.checkSelfPermission(ContactsActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(ContactsActivity.this, new String[]{Manifest.permission.CALL_PHONE}, MY_PERMISSIONS_REQUEST_CALL_PHONE);
        } else {
    ...
    public void onItemClick(Contact contact) {
        Log.d("ContactsActivity", "Selected contact: " + contact.getFullName() + ", Phone: " + contact.getPhone());
